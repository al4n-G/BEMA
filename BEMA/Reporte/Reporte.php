          ...
          <div class="input-box">
           ...
           <img  class="imgf" src="../Imagenes/Logo_ps_Menu.png"  width="80px" />
            ...
            <table>
              ...
              <tr>
                <td> Fecha del diagnostico: <?= $row['EDAD_ACTUAL'] ?></td>
                <td> Constancia de citas: <?= $row['EDAD_ACTUAL'] ?> </td>
              </tr>
            </table>
           ...
           <div class="column-1">
            <a type="submit" class="Actualizar" href="Buscar_Reportes.php">Regresar</a>
